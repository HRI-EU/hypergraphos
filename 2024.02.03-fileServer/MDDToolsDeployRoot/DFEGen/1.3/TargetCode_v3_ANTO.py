...
class NodeData:
    ...
    out_: Dict
    nd_: Dict
    #(ANTO: can't you specify here "props_"?)
    st_: Dict
...
#(ANTO: do you need the compute functions here, before, the nodeData_X?)
#********************
# Compute Functions
#********************
...
def compute_equation_parser(self, name, value):
    if name == 'in':
        ...
        #(ANTO: do you have the concept of 'const', unmutable variable?)
