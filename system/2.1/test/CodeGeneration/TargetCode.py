...
nodeData_9 = NodeData(
    ...
    do_compute= lambda name, value: compute_EquationParser(nodeData_9 ,name, value),
)
...
nodeData_19 = NodeData(
    ...
    do_compute= lambda name, value: compute_EquationCompute(nodeData_19 ,name, value),
)
...
nodeData_26 = NodeData(
    ...
    do_compute= lambda name, value: compute_EquationParser(nodeData_26 ,name, value),
)
# Node Info: [DataFlow_Component] Equation Compute
nodeData_27 = NodeData(
    ...
    do_compute= lambda name, value: compute_EquationCompute(nodeData_27 ,name, value),
)
...
nodeData_58 = NodeData(
    ...
    do_compute= lambda name, value: compute_MakeObject(nodeData_58 ,name, value),
)
...
nodeData_122 = NodeData(
    ...
    do_compute= lambda name, value: compute_DataFlow_Message(nodeData_122 ,name, value),
)
...
nodeData_88 = NodeData(
    ...
    do_compute= lambda name, value: compute_DataFlow_Message(nodeData_88 ,name, value),
)
...
nodeData_92 = NodeData(
    ...
    do_compute= lambda name, value: compute_Component_92(nodeData_92 ,name, value),
)
# Node Info: [DataFlow_Message] alpha = 10\nbeta = 4
nodeData_96 = NodeData(
    ...
    do_compute= lambda name, value: compute_DataFlow_Message(nodeData_96 ,name, value),
)
'''
****************************************
* System Start
