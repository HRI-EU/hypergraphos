...
function getRuleList_Receptionist() {
    return [
      ...
      { // RULE 90 (90): Init Session
        ...
        index: 90,
        fanIn:  [
                  [ { src: 'previousRule', mironName: 'rule5200', type: 'rule', weight: 1 } ], // is previous rule active?: rule5200 
                ],
      ...
      { // RULE 196 (196): Wait for start button
        ...
        index: 196,
        fanIn:  [
                  [ { src: 'previousRule', mironName: 'rule5519',                 type: 'rule',     weight: 0.5 },   // is previous rule active?: rule5519 
      ...
      { // RULE 305 (305): Open Camera & microphone
        ...
        index: 305,
        fanIn:  [
                  [ { src: 'previousRule', mironName: 'rule5189', type: 'rule', weight: 1 } ], // is previous rule active?: rule5189 
                ],
      ...
      { // RULE 380 (380): Inform answer not understood
        ...
        index: 380,
        fanIn:  [
                  [ { src: 'intention',   mironName: 'request_ActionStep2', type: 'internalSpeech', weight: 0.09090909090909091 },   // is inner miron recognized?: request_ActionStep2 
                    { src: 'inhibitedWM', mironName: 'isHelpAsked',         type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isHelpAsked 
                    { src: 'inhibitedWM', mironName: 'isNoInput',           type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isNoInput 
                    { src: 'inhibitedWM', mironName: 'isTooNoisy',          type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isTooNoisy 
                    { src: 'inhibitedWM', mironName: 'isV5',                type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isV5 
                    { src: 'inhibitedWM', mironName: 'isV4',                type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isV4 
                    { src: 'inhibitedWM', mironName: 'isV3',                type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isV3 
                    { src: 'inhibitedWM', mironName: 'isV2',                type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isV2 
                    { src: 'inhibitedWM', mironName: 'isV1',                type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isV1 
                    { src: 'inhibitedWM', mironName: 'isV0',                type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isV0 
                    { src: 'inhibitedWM', mironName: 'isSelection',         type: 'wm',             weight: 0.09090909090909091 } ], // is wm inhibited?: isSelection
      ...
      { // RULE 441 (441): Reinform answer not understood
        ...
        fanIn:  [
                  [ { src: 'inhibitedWM', mironName: 'isTooNoisy',          type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isTooNoisy 
                    { src: 'inhibitedWM', mironName: 'isNoInput',           type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isNoInput 
                    { src: 'inhibitedWM', mironName: 'isHelpAsked',         type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isHelpAsked 
                    { src: 'intention',   mironName: 'request_ActionStep3', type: 'internalSpeech', weight: 0.09090909090909091 },   // is inner miron recognized?: request_ActionStep3 
                    { src: 'inhibitedWM', mironName: 'isV5',                type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isV5 
                    { src: 'inhibitedWM', mironName: 'isV4',                type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isV4 
                    { src: 'inhibitedWM', mironName: 'isV3',                type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isV3 
                    { src: 'inhibitedWM', mironName: 'isV2',                type: 'wm',             weight: 0.09090909090909091 },   // is wm inhibited?: isV2 
      ...
      { // RULE 482 (482): User Answer is Not Understood
        ...
        fanIn:  [
                  [ { src: 'inhibitedWM',  mironName: 'isLastSpeechKnown', type: 'wm',   weight: 0.5 },   // is wm inhibited?: isLastSpeechKnown 
                    { src: 'previousRule', mironName: 'rule5253',          type: 'rule', weight: 0.5 } ], // is previous rule active?: rule5253
                ],
      ...
      { // RULE 621 (621): Visitor is silent by voice 
        ...
        index: 621,
        fanIn:  [
                  [ { src: 'inhibitedWM',  mironName: 'isVisitorSpeaking',                        type: 'wm',       weight: 0.2 },   // is wm inhibited?: isVisitorSpeaking 
                    { src: 'previousRule', mironName: 'rule626',                                  type: 'rule',     weight: 0.2 },   // is previous rule active?: rule626 
                    { src: 'actionDone',   mironName: 'wait_Timeout{timeout:5,id:"timeToSpeak"}', type: 'internal', weight: 0.2 },   // is outer miron done?: wait_Timeout{timeout:5,id:"timeToSpeak"} 
                    { src: 'inhibitedWM',  mironName: 'isVisitorAsweringByVoice',                 type: 'wm',       weight: 0.2 },   // is wm inhibited?: isVisitorAsweringByVoice 
                    { src: 'inhibitedWM',  mironName: 'isTooNoisy',                               type: 'wm',       weight: 0.2 } ], // is wm inhibited?: isTooNoisy
                ],
      ...
      { // RULE 626 (626): Wait for visitor to answer by voice
        ...
        fanOut: [ { dest: 'goal', mironName: 'wait_Timeout{timeout:5,id:"timeToSpeak"}', type: 'internal', weight: 1 },   // do inner miron!: wait_Timeout{timeout:5,id:"timeToSpeak"} 
      ...
      { // RULE 709 (709): Visitor is speaking
        ...
        fanOut: [ { dest: 'activateWM', mironName: 'isVisitorSpeaking',                             type: 'wm',       weight: 1 },   // activate wm!: isVisitorSpeaking 
                  { dest: 'goal',       mironName: 'wait_Timeout{timeout:15,id:"visitorSpeaking"}', type: 'internal', weight: 1 },   // do inner miron!: wait_Timeout{timeout:15,id:"visitorSpeaking"} 
                  { dest: 'inhibitWM',  mironName: 'isTooNoisy',                                    type: 'wm',       weight: 1 } ], // inhibit wm!: isTooNoisy
      },
      { // RULE 718 (718): Visitor finish speaking
        ...
        fanIn:  [
                  ...
                  [ { src: 'intention', mironName: 'close_Microphone', type: 'rightHand', weight: 1 } ], // is outer miron recognized?: close_Microphone 
                  [ { src: 'intention', mironName: 'close_Microphone', type: 'rightHand', weight: 1 } ], // is outer miron recognized?: close_Microphone 
                ],
      ...
      { // RULE 728 (728): User Finished Typing
        ...
        fanIn:  [
                  ...
                  [ { src: 'previousRule', mironName: 'rule5092',          type: 'rule',   weight: 0.5 },   // is previous rule active?: rule5092 
                    { src: 'intention',    mironName: 'keyboard_Validate', type: 'signal', weight: 0.5 } ], // is outer miron recognized?: keyboard_Validate
                ],
        fanOut: [ { dest: 'resetWM',    mironName: 'isVisitorTyping',          type: 'wm',        weight: 1 },   // reset wm!: isVisitorTyping 
      ...
      { // RULE 737 (737): User Is Typing
        ...
        fanOut: [ { dest: 'goal',       mironName: 'wait_Timeout{timeout:10,id:"timeToValidate"}', type: 'internal', weight: 1 },   // do inner miron!: wait_Timeout{timeout:10,id:"timeToValidate"} 
                  { dest: 'activateWM', mironName: 'isVisitorTyping',                              type: 'wm',       weight: 1 } ], // activate wm!: isVisitorTyping
      },
      { // RULE 825 (825): No reaction of user
        name:  'rule825',
        index: 825,
        fanIn:  [
                  [ { src: 'actionDone',   mironName: 'wait_Timeout{timeout:10,id:"userNotClicking"}', type: 'internal', weight: 0.5 },   // is inner miron done?: wait_Timeout{timeout:10,id:"userNotClicking"} 
      ...
      { // RULE 828 (828): User Clicked a Button
        ...
        fanOut: [ { dest: 'activateWM', mironName: 'isVisitorClicking', type: 'wm',        weight: 1 },   // activate wm!: isVisitorClicking 
                  { dest: 'goal',       mironName: 'hide_Buttons',      type: 'rightHand', weight: 1 } ], // do outer miron!: hide_Buttons
      },
      { // RULE 837 (837): User Has Been Presented with Buttons
        ...
        fanOut: [ { dest: 'goal',    mironName: 'wait_Timeout{timeout:10,id:"userNotClicking"}', type: 'internal', weight: 1 },   // do inner miron!: wait_Timeout{timeout:10,id:"userNotClicking"} 
                  { dest: 'resetWM', mironName: 'isVisitorClicking',                             type: 'wm',       weight: 1 } ], // reset wm!: isVisitorClicking
      },
      ...
      { // RULE 915 (915): Visitor answered by voice
        ...
        fanIn:  [
                  [ { src: 'previousRule', mironName: 'rule626',                  type: 'rule', weight: 0.25 },   // is previous rule active?: rule626 
                    { src: 'activatedWM',  mironName: 'isVisitorAsweringByVoice', type: 'wm',   weight: 0.25 },   // is wm activated?: isVisitorAsweringByVoice 
                    { src: 'inhibitedWM',  mironName: 'isVisitorSpeaking',        type: 'wm',   weight: 0.25 },   // is wm inhibited?: isVisitorSpeaking 
                    { src: 'inhibitedWM',  mironName: 'isTooNoisy',               type: 'wm',   weight: 0.25 } ], // is wm inhibited?: isTooNoisy
                  [ { src: 'previousRule', mironName: 'rule868', type: 'rule', weight: 1 } ], // is previous rule active?: rule868 
                ],
        fanOut: [ { dest: 'inhibitWM', mironName: 'isNoInput',                  type: 'wm',             weight: 1 },   // inhibit wm!: isNoInput 
      ...
      { // RULE 922 (922): Visitor is answering by voice
        ...
        fanIn:  [
                  ...
                  [ { src: 'previousRule', mironName: 'rule626',                                  type: 'rule',     weight: 0.3333333333333333 },   // is previous rule active?: rule626 
                    { src: 'activatedWM',  mironName: 'isVisitorSpeaking',                        type: 'wm',       weight: 0.3333333333333333 },   // is wm activated?: isVisitorSpeaking 
                    { src: 'actionDone',   mironName: 'wait_Timeout{timeout:5,id:"timeToSpeak"}', type: 'internal', weight: 0.3333333333333333 } ], // is outer miron done?: wait_Timeout{timeout:5,id:"timeToSpeak"}
                ],
      ...
      { // RULE 993 (993): Environment is too noisy
        ...
        fanIn:  [
                  [ { src: 'previousRule', mironName: 'rule626',                  type: 'rule', weight: 0.25 },   // is previous rule active?: rule626 
                    { src: 'activatedWM',  mironName: 'isTooNoisy',               type: 'wm',   weight: 0.25 },   // is wm activated?: isTooNoisy 
                    { src: 'inhibitedWM',  mironName: 'isVisitorSpeaking',        type: 'wm',   weight: 0.25 },   // is wm inhibited?: isVisitorSpeaking 
                    { src: 'activatedWM',  mironName: 'isVisitorAsweringByVoice', type: 'wm',   weight: 0.25 } ], // is wm activated?: isVisitorAsweringByVoice
                ],
      ...
      { // RULE 877 (877): Sound environment too noisy
        name:  'rule877',
        index: 877,
        fanIn:  [
                  [ { src: 'previousRule', mironName: 'rule709',                                       type: 'rule',     weight: 0.5 },   // is previous rule active?: rule709 
                    { src: 'actionDone',   mironName: 'wait_Timeout{timeout:15,id:"visitorSpeaking"}', type: 'internal', weight: 0.5 } ], // is inner miron done?: wait_Timeout{timeout:15,id:"visitorSpeaking"}
                  [ { src: 'intention',    mironName: 'speech_End', type: 'signal', weight: -0.5 },   // is outer miron recognized?: speech_End 
                    { src: 'previousRule', mironName: 'rule709',    type: 'rule',   weight: -0.5 } ], // is previous rule active?: rule709
                ],
      ...
      { // RULE 1019 (1019): Visitor is answering
        ...
        index: 1019,
        fanIn:  [
                  [ { src: 'previousRule', mironName: 'rule1031',        type: 'rule', weight: 0.5 },   // is previous rule active?: rule1031 
                    { src: 'activatedWM',  mironName: 'isVisitorTyping', type: 'wm',   weight: 0.5 } ], // is wm activated?: isVisitorTyping
                ],
        fanOut: [ { dest: 'goal', mironName: 'log_VisitorAnsweringByKeyboard',           type: 'internal', weight: 1 },   // do inner miron!: log_VisitorAnsweringByKeyboard 
                  { dest: 'goal', mironName: 'wait_Timeout{timeout:60,id:"timeToType"}', type: 'internal', weight: 1 } ], // do inner miron!: wait_Timeout{timeout:60,id:"timeToType"}
      },
      { // RULE 1023 (1023): Visitor answered by keyboard
        name:  'rule1023',
        index: 1023,
        fanIn:  [
                  [ { src: 'activatedWM',  mironName: 'hasVisitorFinishedTyping', type: 'wm',   weight: 0.5 },   // is wm activated?: hasVisitorFinishedTyping 
                    { src: 'previousRule', mironName: 'rule1019',                 type: 'rule', weight: 0.5 } ], // is previous rule active?: rule1019
                  [ { src: 'previousRule', mironName: 'rule1019',                                 type: 'rule',     weight: 0.5 },   // is previous rule active?: rule1019 
                    { src: 'actionDone',   mironName: 'wait_Timeout{timeout:60,id:"timeToType"}', type: 'internal', weight: 0.5 } ], // is outer miron done?: wait_Timeout{timeout:60,id:"timeToType"}
                ],
        fanOut: [ { dest: 'goal',      mironName: 'log_VisitorAnsweredByKeyboard', type: 'internal',       weight: 1 },   // do inner miron!: log_VisitorAnsweredByKeyboard 
                  { dest: 'inhibitWM', mironName: 'isNoInput',                     type: 'wm',             weight: 1 },   // inhibit wm!: isNoInput 
                  { dest: 'goal',      mironName: 'request_ToCheckAnswer',         type: 'internalSpeech', weight: 1 } ], // do inner miron!: request_ToCheckAnswer
      },
      ...
      { // RULE 1031 (1031): Wait for visitor to answer by keyboard
        ...
        fanOut: [ { dest: 'goal', mironName: 'log_WaitForVisitorToAnswerByKeyboard', type: 'internal', weight: 1 } ], // do inner miron!: log_WaitForVisitorToAnswerByKeyboard 
      },
      { // RULE 1036 (1036): Visitor is silent by keyboard
        name:  'rule1036',
        index: 1036,
        fanIn:  [
                  [ { src: 'inhibitedWM',  mironName: 'isVisitorTyping', type: 'wm',   weight: 0.5 },   // is wm inhibited?: isVisitorTyping 
                    { src: 'previousRule', mironName: 'rule1031',        type: 'rule', weight: 0.5 } ], // is previous rule active?: rule1031
                ],
      ...
      { // RULE 1091 (1091): Analyse answer
        ...
        index: 1091,
        fanIn:  [
                  [ { src: 'inhibitedWM',  mironName: 'isRepeatAsked', type: 'wm',   weight: 0.3333333333333333 },   // is wm inhibited?: isRepeatAsked 
                    { src: 'previousRule', mironName: 'rule2994',      type: 'rule', weight: 0.3333333333333333 },   // is previous rule active?: rule2994 
                    { src: 'inhibitedWM',  mironName: 'isHelpAsked',   type: 'wm',   weight: 0.3333333333333333 } ], // is wm inhibited?: isHelpAsked
                ],
      ...
      { // RULE 1273 (1273): Reinform answer not understood
        ...
        index: 1273,
        fanIn:  [
                  [ { src: 'inhibitedWM', mironName: 'isNoInput',           type: 'wm',             weight: 0.1 },   // is wm inhibited?: isNoInput 
                    { src: 'intention',   mironName: 'request_ActionStep4', type: 'internalSpeech', weight: 0.1 },   // is inner miron recognized?: request_ActionStep4 
                    { src: 'inhibitedWM', mironName: 'isHelpAsked',         type: 'wm',             weight: 0.1 },   // is wm inhibited?: isHelpAsked 
                    { src: 'inhibitedWM', mironName: 'isV0',                type: 'wm',             weight: 0.1 },   // is wm inhibited?: isV0 
                    { src: 'inhibitedWM', mironName: 'isV1',                type: 'wm',             weight: 0.1 },   // is wm inhibited?: isV1 
                    { src: 'inhibitedWM', mironName: 'isV2',                type: 'wm',             weight: 0.1 },   // is wm inhibited?: isV2 
                    { src: 'inhibitedWM', mironName: 'isV3',                type: 'wm',             weight: 0.1 },   // is wm inhibited?: isV3 
                    { src: 'inhibitedWM', mironName: 'isV4',                type: 'wm',             weight: 0.1 },   // is wm inhibited?: isV4 
                    { src: 'inhibitedWM', mironName: 'isV5',                type: 'wm',             weight: 0.1 },   // is wm inhibited?: isV5 
                    { src: 'inhibitedWM', mironName: 'isSelection',         type: 'wm',             weight: 0.1 } ], // is wm inhibited?: isSelection
      ...
      { // RULE 1579 (1579): Call MST
        ...
        index: 1579,
        fanIn:  [
                  [ { src: 'previousRule', mironName: 'rule5478', type: 'rule', weight: 1 } ], // is previous rule active?: rule5478 
                ],
      ...
      { // RULE 1580 (1580): Select MST phone number
        ...
        fanOut: [ { dest: 'goal', mironName: 'recall_MSTInfo', type: 'internal', weight: 1 } ], // do inner miron!: recall_MSTInfo 
      },
      ...
      { // RULE 2146 (2146): Visitor is silent by keyboard
        ...
        index: 2146,
        fanIn:  [
                  [ { src: 'previousRule', mironName: 'rule2150',          type: 'rule', weight: 0.5 },   // is previous rule active?: rule2150 
                    { src: 'inhibitedWM',  mironName: 'isVisitorClicking', type: 'wm',   weight: 0.5 } ], // is wm inhibited?: isVisitorClicking
                ],
        fanOut: [ { dest: 'activateWM', mironName: 'isNoInput',                   type: 'wm',             weight: 1 },   // activate wm!: isNoInput 
                  { dest: 'goal',       mironName: 'request_NextQuestion',        type: 'internalSpeech', weight: 1 },   // do inner miron!: request_NextQuestion 
      ...
      { // RULE 2158 (2158): Visitor answered by keyboard
        ...
        index: 2158,
        fanIn:  [
                  [ { src: 'activatedWM',  mironName: 'isVisitorClicking', type: 'wm',   weight: 0.5 },   // is wm activated?: isVisitorClicking 
                    { src: 'previousRule', mironName: 'rule2150',          type: 'rule', weight: 0.5 } ], // is previous rule active?: rule2150
                ],
      ...
      { // RULE 2249 (2249): Say hello
        ...
        fanIn:  [
                  ...
                  [ { src: 'emptySlot',    mironName: 'interlocutorTitle', type: 'slot', weight: 0.5 },   // is active?: interlocutorTitle 
                    { src: 'previousRule', mironName: 'rule2271',          type: 'rule', weight: 0.5 } ], // is previous rule active?: rule2271
                ],
      ...
      { // RULE 3494 (3494): Case of yes/no validation 
        name:  'rule3494',
        index: 3494,
        fanIn:  [
                  [ { src: 'activatedWM', mironName: 'isV0',                  type: 'wm',             weight: 0.5 },   // is wm activated?: isV0 
                  ...
                  [ { src: 'activatedWM', mironName: 'isV1',                  type: 'wm',             weight: 0.5 },   // is wm activated?: isV1 
                    { src: 'intention',   mironName: 'request_ToCheckAnswer', type: 'internalSpeech', weight: 0.5 } ], // is inner miron recognized?: request_ToCheckAnswer
                  [ { src: 'activatedWM', mironName: 'isV2',                  type: 'wm',             weight: 0.5 },   // is wm activated?: isV2 
                    { src: 'intention',   mironName: 'request_ToCheckAnswer', type: 'internalSpeech', weight: 0.5 } ], // is inner miron recognized?: request_ToCheckAnswer
                  [ { src: 'activatedWM', mironName: 'isV3',                  type: 'wm',             weight: 0.5 },   // is wm activated?: isV3 
                    { src: 'intention',   mironName: 'request_ToCheckAnswer', type: 'internalSpeech', weight: 0.5 } ], // is inner miron recognized?: request_ToCheckAnswer
                  [ { src: 'activatedWM', mironName: 'isV4',                  type: 'wm',             weight: 0.5 },   // is wm activated?: isV4 
                    { src: 'intention',   mironName: 'request_ToCheckAnswer', type: 'internalSpeech', weight: 0.5 } ], // is inner miron recognized?: request_ToCheckAnswer
                  [ { src: 'activatedWM', mironName: 'isV5',                  type: 'wm',             weight: 0.5 },   // is wm activated?: isV5 
                    { src: 'intention',   mironName: 'request_ToCheckAnswer', type: 'internalSpeech', weight: 0.5 } ], // is inner miron recognized?: request_ToCheckAnswer
                ],
        fanOut: [],   
      },
      { // RULE 3624 (3624): Security Timer
        ...
        fanIn:  [
                  ...
                  [ { src: 'intention', mironName: 'say_Something', type: 'internalSpeech', weight: 1 } ], // is inner miron recognized?: say_Something 
                  [ { src: 'intention', mironName: 'ask_Something', type: 'internalSpeech', weight: 1 } ], // is inner miron recognized?: ask_Something 
                  [ { src: 'intention', mironName: 'keyboard_Type', type: 'signal', weight: 1 } ], // is outer miron recognized?: keyboard_Type 
                  [ { src: 'intention', mironName: 'button_Click', type: 'signal', weight: 1 } ], // is outer miron recognized?: button_Click 
                  [ { src: 'intention', mironName: 'request_ToSendEmailToContact_Done', type: 'internalSpeech', weight: 1 } ], // is inner miron recognized?: request_ToSendEmailToContact_Done 
                  [ { src: 'intention', mironName: 'request_ToCall_Done', type: 'internalSpeech', weight: 1 } ], // is inner miron recognized?: request_ToCall_Done 
                  [ { src: 'intention', mironName: 'request_ToSendEmailToMST_Done', type: 'internalSpeech', weight: 1 } ], // is inner miron recognized?: request_ToSendEmailToMST_Done 
                ],
      ...
      { // RULE 4664 (4664): Reactivate timer (Bug in Behavior Engine)
        ...
        fanIn:  [
                  [ { src: 'intention',    mironName: 'keyboard_Type', type: 'signal', weight: 0.5 },   // is outer miron recognized?: keyboard_Type 
                    { src: 'previousRule', mironName: 'rule4485',      type: 'rule',   weight: 0.5 } ], // is previous rule active?: rule4485
                  [ { src: 'previousRule', mironName: 'rule737',       type: 'rule',   weight: 0.5 },   // is previous rule active?: rule737 
                    { src: 'intention',    mironName: 'keyboard_Type', type: 'signal', weight: 0.5 } ], // is outer miron recognized?: keyboard_Type
                ],
        fanOut: [],   
      ...
      { // RULE 4485 (4485): Keyboard presented
        name:  'rule4485',
        index: 4485,
        fanIn:  [
                  [ { src: 'intention', mironName: 'keyboard_Show', type: 'signal', weight: 1 } ], // is outer miron recognized?: keyboard_Show 
                ],
        fanOut: [ { dest: 'resetWM', mironName: 'hasVisitorFinishedTyping',                    type: 'wm',       weight: 1 },   // reset wm!: hasVisitorFinishedTyping 
                  { dest: 'goal',    mironName: 'wait_Timeout{timeout:10,id:"userNotTyping"}', type: 'internal', weight: 1 },   // do inner miron!: wait_Timeout{timeout:10,id:"userNotTyping"} 
                  { dest: 'resetWM', mironName: 'isVisitorTyping',                             type: 'wm',       weight: 1 } ], // reset wm!: isVisitorTyping
      },
      { // RULE 4523 (4523): No reaction of user
        name:  'rule4523',
        index: 4523,
        fanIn:  [
                  [ { src: 'actionDone',   mironName: 'wait_Timeout{timeout:10,id:"userNotTyping"}', type: 'internal', weight: 0.5 },   // is inner miron done?: wait_Timeout{timeout:10,id:"userNotTyping"} 
                    { src: 'previousRule', mironName: 'rule4485',                                    type: 'rule',     weight: 0.5 } ], // is previous rule active?: rule4485
                  [ { src: 'intention',    mironName: 'keyboard_Type', type: 'signal', weight: -0.5 },   // is outer miron recognized?: keyboard_Type 
                    { src: 'previousRule', mironName: 'rule4485',      type: 'rule',   weight: -0.5 } ], // is previous rule active?: rule4485
                ],
      ...
      { // RULE 5092 (5092): Validate keyboard after timeout 
        name:  'rule5092',
        index: 5092,
        fanIn:  [
                  [ { src: 'actionDone',   mironName: 'wait_Timeout{timeout:10,id:"timeToValidate"}', type: 'internal', weight: 0.5 },   // is inner miron done?: wait_Timeout{timeout:10,id:"timeToValidate"} 
                    { src: 'previousRule', mironName: 'rule737',                                      type: 'rule',     weight: 0.5 } ], // is previous rule active?: rule737
                ],
        fanOut: [ { dest: 'goal', mironName: 'validate_Keyboard', type: 'rightHand', weight: 1 } ], // do outer miron!: validate_Keyboard 
      },
      { // RULE 5216 (5216): Visitor did not answer with yes or no
        name:  'rule5216',
        index: 5216,
        fanIn:  [
                  [ { src: 'previousRule', mironName: 'rule3494',           type: 'rule', weight: 0.3333333333333333 },   // is previous rule active?: rule3494 
                    { src: 'inhibitedWM',  mironName: 'isNameConfirmed',    type: 'wm',   weight: 0.3333333333333333 },   // is wm inhibited?: isNameConfirmed 
                    { src: 'inhibitedWM',  mironName: 'isNameDisconfirmed', type: 'wm',   weight: 0.3333333333333333 } ], // is wm inhibited?: isNameDisconfirmed
                ],
        fanOut: [],   
      },
      { // RULE 5253 (5253): Case of normal questions
        name:  'rule5253',
        index: 5253,
        fanIn:  [
                  [ { src: 'inhibitedWM', mironName: 'isV0',                  type: 'wm',             weight: 0.14285714285714285 },   // is wm inhibited?: isV0 
                    { src: 'inhibitedWM', mironName: 'isV1',                  type: 'wm',             weight: 0.14285714285714285 },   // is wm inhibited?: isV1 
                    { src: 'inhibitedWM', mironName: 'isV2',                  type: 'wm',             weight: 0.14285714285714285 },   // is wm inhibited?: isV2 
                    { src: 'inhibitedWM', mironName: 'isV3',                  type: 'wm',             weight: 0.14285714285714285 },   // is wm inhibited?: isV3 
                    { src: 'inhibitedWM', mironName: 'isV4',                  type: 'wm',             weight: 0.14285714285714285 },   // is wm inhibited?: isV4 
                    { src: 'inhibitedWM', mironName: 'isV5',                  type: 'wm',             weight: 0.14285714285714285 },   // is wm inhibited?: isV5 
                    { src: 'intention',   mironName: 'request_ToCheckAnswer', type: 'internalSpeech', weight: 0.14285714285714285 } ], // is inner miron recognized?: request_ToCheckAnswer
                ],
        fanOut: [],   
      },
      { // RULE 5305 (5305): Yes or no  is Understood
        name:  'rule5305',
        index: 5305,
        fanIn:  [
                  [ { src: 'previousRule', mironName: 'rule3494',        type: 'rule', weight: 0.5 },   // is previous rule active?: rule3494 
                    { src: 'activatedWM',  mironName: 'isNameConfirmed', type: 'wm',   weight: 0.5 } ], // is wm activated?: isNameConfirmed
                  [ { src: 'previousRule', mironName: 'rule3494',           type: 'rule', weight: 0.5 },   // is previous rule active?: rule3494 
                    { src: 'activatedWM',  mironName: 'isNameDisconfirmed', type: 'wm',   weight: 0.5 } ], // is wm activated?: isNameDisconfirmed
                ],
        fanOut: [ { dest: 'goal',       mironName: 'log_Stat_FullyUnderstood',   type: 'internal',       weight: 1 },   // do inner miron!: log_Stat_FullyUnderstood 
                  { dest: 'goal',       mironName: 'request_ToAnalyseSituation', type: 'internalSpeech', weight: 1 },   // do inner miron!: request_ToAnalyseSituation 
                  { dest: 'activateWM', mironName: 'isVisitorUnderstood',        type: 'wm',             weight: 1 },   // activate wm!: isVisitorUnderstood 
                  { dest: 'goal',       mironName: 'log_VisitorNotUnderstood',   type: 'internal',       weight: 1 } ], // do inner miron!: log_VisitorNotUnderstood
      },
      { // RULE 5361 (5361): Analyse answer
        name:  'rule5361',
        index: 5361,
        fanIn:  [
                  [ { src: 'inhibitedWM',  mironName: 'isRepeatAsked', type: 'wm',   weight: 0.3333333333333333 },   // is wm inhibited?: isRepeatAsked 
                    { src: 'previousRule', mironName: 'rule5216',      type: 'rule', weight: 0.3333333333333333 },   // is previous rule active?: rule5216 
                    { src: 'inhibitedWM',  mironName: 'isHelpAsked',   type: 'wm',   weight: 0.3333333333333333 } ], // is wm inhibited?: isHelpAsked
                ],
      ...
      { // RULE 5371 (5371): Visitor asked to repeat
        name:  'rule5371',
        index: 5371,
        fanIn:  [
                  [ { src: 'activatedWM',  mironName: 'isRepeatAsked', type: 'wm',   weight: 0.5 },   // is wm activated?: isRepeatAsked 
                    { src: 'previousRule', mironName: 'rule5216',      type: 'rule', weight: 0.5 } ], // is previous rule active?: rule5216
                ],
        fanOut: [ { dest: 'goal',      mironName: 'log_VisitorAskedToRepeat', type: 'internal',       weight: 1 },   // do inner miron!: log_VisitorAskedToRepeat 
                  { dest: 'goal',      mironName: 'ask_Something',            type: 'internalSpeech', weight: 1 },   // do inner miron!: ask_Something 
                  { dest: 'inhibitWM', mironName: 'isRepeatAsked',            type: 'wm',             weight: 1 },   // inhibit wm!: isRepeatAsked 
                  { dest: 'goal',      mironName: 'log_Stat_FullyUnderstood', type: 'internal',       weight: 1 },   // do inner miron!: log_Stat_FullyUnderstood 
                  { dest: 'inhibitWM', mironName: 'isHelpAsked',              type: 'wm',             weight: 1 } ], // inhibit wm!: isHelpAsked
      },
      { // RULE 5414 (5414): Analyse answer
        name:  'rule5414',
        index: 5414,
        fanIn:  [
                  [ { src: 'activatedWM',  mironName: 'isHelpAsked',   type: 'wm',   weight: 0.3333333333333333 },   // is wm activated?: isHelpAsked 
                    { src: 'inhibitedWM',  mironName: 'isRepeatAsked', type: 'wm',   weight: 0.3333333333333333 },   // is wm inhibited?: isRepeatAsked 
                    { src: 'previousRule', mironName: 'rule5216',      type: 'rule', weight: 0.3333333333333333 } ], // is previous rule active?: rule5216
                ],
        fanOut: [ { dest: 'goal',       mironName: 'request_NextQuestion',     type: 'internalSpeech', weight: 1 },   // do inner miron!: request_NextQuestion 
                  { dest: 'goal',       mironName: 'log_Stat_FullyUnderstood', type: 'internal',       weight: 1 },   // do inner miron!: log_Stat_FullyUnderstood 
                  { dest: 'goal',       mironName: 'log_CaseHelpInVx',         type: 'internal',       weight: 1 },   // do inner miron!: log_CaseHelpInVx 
                  { dest: 'activateWM', mironName: 'isVisitorUnderstood',      type: 'wm',             weight: 1 } ], // activate wm!: isVisitorUnderstood
      },
      { // RULE 5444 (5444): Analyse answer
        name:  'rule5444',
        index: 5444,
        fanIn:  [
                  [ { src: 'inhibitedWM',  mironName: 'isRepeatAsked', type: 'wm',   weight: 0.3333333333333333 },   // is wm inhibited?: isRepeatAsked 
        ...
        fanOut: [ { dest: 'goal', mironName: 'log_CaseHelp',         type: 'internal',       weight: 1 },   // do inner miron!: log_CaseHelp 
                  { dest: 'goal', mironName: 'request_NextQuestion', type: 'internalSpeech', weight: 1 } ], // do inner miron!: request_NextQuestion
      },
      { // RULE 5478 (5478): this step is necessary for the slots modified by recall_MSTInfo to be available
        name:  'rule5478',
        index: 5478,
        fanIn:  [
                  [ { src: 'previousRule', mironName: 'rule1580',       type: 'rule',     weight: 0.5 },   // is previous rule active?: rule1580 
                    { src: 'actionDone',   mironName: 'recall_MSTInfo', type: 'internal', weight: 0.5 } ], // is inner miron done?: recall_MSTInfo
                ],
        fanOut: [],   
      },
      { // RULE 5519 (5519): Display disclaimer splash & close microphone
        name:  'rule5519',
        index: 5519,
        fanIn:  [
        ...
        fanOut: [ { dest: 'goal', mironName: 'request_CheckDBEmpty', type: 'internalSpeech', weight: 1 } ], // do inner miron!: request_CheckDBEmpty 
      },
      { // RULE 5105 (5105): Call successful
        ...
        fanIn:  [
                  [ { src: 'intention',    mironName: 'say_Something_Done', type: 'internalSpeech', weight: 0.5 },   // is inner miron recognized?: say_Something_Done 
                    { src: 'previousRule', mironName: 'rule5174',           type: 'rule',           weight: 0.5 } ], // is previous rule active?: rule5174
                  [ { src: 'intention',    mironName: 'say_Something_Done', type: 'internalSpeech', weight: 0.5 },   // is inner miron recognized?: say_Something_Done 
                    { src: 'previousRule', mironName: 'rule4717',           type: 'rule',           weight: 0.5 } ], // is previous rule active?: rule4717
                ],
        fanOut: [ { dest: 'activateWM', mironName: 'isCallSuccessful', type: 'wm', weight: 1 } ], // activate wm!: isCallSuccessful 
      },
      { // RULE 5090 (5090): Say MST "Can you come"
        name:  'rule5090',
        index: 5090,
        fanIn:  [
        ...
        fanOut: [ { dest: 'goal', mironName: 'say_Something',                                                  type: 'internalSpeech', weight: 1 },   // do inner miron!: say_Something 
                  { dest: 'goal', mironName: 'setMironSlot{mironType:"speech",mironName:"say_MSTCanYouCome"}', type: 'internal',       weight: 1 } ], // do inner miron!: setMironSlot{mironType:"speech",mironName:"say_MSTCanYouCome"}
      },
      { // RULE 5077 (5077): Say "your visitor"
        name:  'rule5077',
        index: 5077,
        fanIn:  [
        ...
        fanOut: [ { dest: 'goal', mironName: 'say_Something',                                                type: 'internalSpeech', weight: 1 },   // do inner miron!: say_Something 
                  { dest: 'goal', mironName: 'setMironSlot{mironType:"speech",mironName:"say_YourVisitor"}', type: 'internal',       weight: 1 } ], // do inner miron!: setMironSlot{mironType:"speech",mironName:"say_YourVisitor"}
      },
      { // RULE 5043 (5043): Call not Answered or finished
        ...
        fanOut: [ { dest: 'goal', mironName: 'lookAt_Something',    type: 'internalGaze',   weight: 1 },   // do inner miron!: lookAt_Something 
                  { dest: 'goal', mironName: 'setGazeTo_Front',     type: 'internalGaze',   weight: 1 },   // do inner miron!: setGazeTo_Front 
                  { dest: 'goal', mironName: 'drop_Phone',          type: 'rightHand',      weight: 1 },   // do outer miron!: drop_Phone 
                  { dest: 'goal', mironName: 'request_ToCall_Done', type: 'internalSpeech', weight: 1 } ], // do inner miron!: request_ToCall_Done
      },
      ...
      { // RULE 4931 (4931): Say good bye
        ...
        fanOut: [ { dest: 'goal', mironName: 'say_Something',                                                    type: 'internalSpeech', weight: 1 },   // do inner miron!: say_Something 
                  { dest: 'goal', mironName: 'setMironSlot{mironType:"speech",mironName:"say_PhoneSalutation"}', type: 'internal',       weight: 1 } ], // do inner miron!: setMironSlot{mironType:"speech",mironName:"say_PhoneSalutation"}
      },
      ...
      { // RULE 4789 (4789): Wait in case contact would speak
        ...
        fanOut: [ { dest: 'goal', mironName: 'animate_Out',                               type: 'internalEmotion', weight: 1 },   // do inner miron!: animate_Out 
      ...
      { // RULE 4756 (4756): Clean type of call flags
        ...
        fanIn:  [
                  ...
                  [ { src: 'activatedWM',  mironName: 'isCallEnded', type: 'wm',   weight: 0.5 },   // is wm activated?: isCallEnded 
                    { src: 'previousRule', mironName: 'rule4717',    type: 'rule', weight: 0.5 } ], // is previous rule active?: rule4717
                  [ { src: 'activatedWM',  mironName: 'isCallEnded', type: 'wm',   weight: 0.5 },   // is wm activated?: isCallEnded 
                    { src: 'previousRule', mironName: 'rule4453',    type: 'rule', weight: 0.5 } ], // is previous rule active?: rule4453
                  [ { src: 'previousRule', mironName: 'rule5094',    type: 'rule', weight: 0.5 },   // is previous rule active?: rule5094 
                    { src: 'activatedWM',  mironName: 'isCallEnded', type: 'wm',   weight: 0.5 } ], // is wm activated?: isCallEnded
                  [ { src: 'previousRule', mironName: 'rule5174',    type: 'rule', weight: 0.5 },   // is previous rule active?: rule5174 
                    { src: 'activatedWM',  mironName: 'isCallEnded', type: 'wm',   weight: 0.5 } ], // is wm activated?: isCallEnded
                ],
        fanOut: [ { dest: 'inhibitWM', mironName: 'isCallToMST',                type: 'wm',             weight: 1 },   // inhibit wm!: isCallToMST 
                  { dest: 'inhibitWM', mironName: 'isCallToContact',            type: 'wm',             weight: 1 },   // inhibit wm!: isCallToContact 
                  { dest: 'goal',      mironName: 'request_InformAtPhone_Done', type: 'internalSpeech', weight: 1 } ], // do inner miron!: request_InformAtPhone_Done
      },
      ...
      { // RULE 4681 (4681): Call Answered
        ...
        fanOut: [ { dest: 'goal', mironName: 'animate_In',               type: 'internalEmotion', weight: 1 },   // do inner miron!: animate_In 
                  { dest: 'goal', mironName: 'setAnimationTo_Happiness', type: 'internalEmotion', weight: 1 },   // do inner miron!: setAnimationTo_Happiness 
                  { dest: 'goal', mironName: 'request_InformAtPhone',    type: 'internalSpeech',  weight: 1 } ], // do inner miron!: request_InformAtPhone
      },
      { // RULE 4510 (4510): Call Answered
        ...
        fanOut: [ { dest: 'goal', mironName: 'say_Something',                                                  type: 'internalSpeech', weight: 1 },   // do inner miron!: say_Something 
                  { dest: 'goal', mironName: 'setMironSlot{mironType:"speech",mironName:"say_PhoneItsMeisy"}', type: 'internal',       weight: 1 } ], // do inner miron!: setMironSlot{mironType:"speech",mironName:"say_PhoneItsMeisy"}
      },
      ...
      { // RULE 4344 (4344): I start calling
        ...
        fanOut: [ { dest: 'resetWM', mironName: 'isCallTooLong', type: 'wm', weight: 1 },   // reset wm!: isCallTooLong 
                  { dest: 'resetWM', mironName: 'isCallEnded',   type: 'wm', weight: 1 },   // reset wm!: isCallEnded 
                  { dest: 'resetWM', mironName: 'isCallStarted', type: 'wm', weight: 1 } ], // reset wm!: isCallStarted
      },
      ...
      { // RULE 5013 (5013): Start call
        ...
        fanOut: [ { dest: 'resetWM', mironName: 'isCallEnded',      type: 'wm',        weight: 1 },   // reset wm!: isCallEnded 
      ...
      { // RULE 4991 (4991): User Clicked a Button
        ...
        fanOut: [ { dest: 'inhibitWM',  mironName: 'isCallTooLong', type: 'wm', weight: 1 },   // inhibit wm!: isCallTooLong 
                  { dest: 'activateWM', mironName: 'isCallEnded',   type: 'wm', weight: 1 },   // activate wm!: isCallEnded 
                  { dest: 'inhibitWM',  mironName: 'isCallStarted', type: 'wm', weight: 1 } ], // inhibit wm!: isCallStarted
      },
      { // RULE 4963 (4963): I start calling
        ...
        fanOut: [ { dest: 'inhibitWM',  mironName: 'isCallTooLong',                         type: 'wm',       weight: 1 },   // inhibit wm!: isCallTooLong 
                  ...
                  { dest: 'activateWM', mironName: 'isCallStarted',                         type: 'wm',       weight: 1 } ], // activate wm!: isCallStarted
      },
      { // RULE 4923 (4923): Take the phone
        ...
        fanOut: [ { dest: 'goal', mironName: 'lookAt_Something', type: 'internalGaze', weight: 1 },   // do inner miron!: lookAt_Something 
                  { dest: 'goal', mironName: 'setGazeTo_Left',   type: 'internalGaze', weight: 1 },   // do inner miron!: setGazeTo_Left 
                  { dest: 'goal', mironName: 'take_Phone',       type: 'rightHand',    weight: 1 } ], // do outer miron!: take_Phone
      },
      { // RULE 4453 (4453): Say "visitor name"
        name:  'rule4453',
        index: 4453,
        fanIn:  [
                  [ { src: 'intention',    mironName: 'say_Something_Done', type: 'internalSpeech', weight: 0.5 },   // is inner miron recognized?: say_Something_Done 
        ...
        fanOut: [ { dest: 'goal', mironName: 'setMironSlot{mironType:"speech",mironName:"say_VisitorName"}', type: 'internal',       weight: 1 },   // do inner miron!: setMironSlot{mironType:"speech",mironName:"say_VisitorName"} 
                  { dest: 'goal', mironName: 'say_Something',                                                type: 'internalSpeech', weight: 1 } ], // do inner miron!: say_Something
      },
      { // RULE 4717 (4717): Say "is waiting in the lobby"
        name:  'rule4717',
        index: 4717,
        fanIn:  [
                  [ { src: 'intention',    mironName: 'say_Something_Done', type: 'internalSpeech', weight: 0.5 },   // is inner miron recognized?: say_Something_Done 
        ...
        fanOut: [ { dest: 'goal', mironName: 'setMironSlot{mironType:"speech",mironName:"say_IsWaitingAtLobby"}', type: 'internal',       weight: 1 },   // do inner miron!: setMironSlot{mironType:"speech",mironName:"say_IsWaitingAtLobby"} 
                  { dest: 'goal', mironName: 'say_Something',                                                     type: 'internalSpeech', weight: 1 } ], // do inner miron!: say_Something
      },
      { // RULE 5094 (5094): Say MST "contact name"
        name:  'rule5094',
        index: 5094,
        fanIn:  [
                  [ { src: 'intention',    mironName: 'say_Something_Done', type: 'internalSpeech', weight: 0.5 },   // is inner miron recognized?: say_Something_Done 
        ...
        fanOut: [ { dest: 'goal', mironName: 'say_Something',                                                   type: 'internalSpeech', weight: 1 },   // do inner miron!: say_Something 
                  { dest: 'goal', mironName: 'setMironSlot{mironType:"speech",mironName:"say_MSTContactName"}', type: 'internal',       weight: 1 } ], // do inner miron!: setMironSlot{mironType:"speech",mironName:"say_MSTContactName"}
      },
      { // RULE 5174 (5174): Say MST "is not reachable"
        name:  'rule5174',
        index: 5174,
        fanIn:  [
                  [ { src: 'intention',    mironName: 'say_Something_Done', type: 'internalSpeech', weight: 0.5 },   // is inner miron recognized?: say_Something_Done 
        ...
        fanOut: [ { dest: 'goal', mironName: 'say_Something',                                                      type: 'internalSpeech', weight: 1 },   // do inner miron!: say_Something 
                  { dest: 'goal', mironName: 'setMironSlot{mironType:"speech",mironName:"say_MSTIsNotReachable"}', type: 'internal',       weight: 1 } ], // do inner miron!: setMironSlot{mironType:"speech",mironName:"say_MSTIsNotReachable"}
      },
      { // RULE 5189 (5189): Start logging Stats
        name:  'rule5189',
        index: 5189,
        fanIn:  [
        ...
        fanOut: [ { dest: 'goal', mironName: 'log_Stat_Start', type: 'internal', weight: 1 } ], // do inner miron!: log_Stat_Start 
      },
      { // RULE 5200 (5200): Start Logging 
        name:  'rule5200',
        index: 5200,
        fanIn:  [
                  [ { src: 'intention', mironName: 'request_InitPhase', type: 'internalSpeech', weight: 1 } ], // is inner miron recognized?: request_InitPhase 
                ],
        fanOut: [ { dest: 'goal', mironName: 'log_StartSession', type: 'internal', weight: 1 } ], // do inner miron!: log_StartSession 
      },
    ];
  } 