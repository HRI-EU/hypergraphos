...
/*		const groupTemplate = $(go.Group, "Vertical",
  ...
  const dsl = {
    templateNodeList: [
      ...
      { category: 'Hierarchy_Engine',         template: dsl_Component, param: { g, hasInputs: false, hasOutputs: false, hasFunctionButtons: false, hasTag: false, hasType: false, hasValue: true,  hasUnit: false,  figure: "File", fill: "LightSteelBlue", canAddProperties: false, hasIcon: true, iconURL: 'fileServer/pictures/Engine.png', iconWidth: 50, iconHeight: 50, isResizable: false, minSize: new go.Size(240, 80), isFromLinkable: false, isToLinkable: false,} },
      ...
      { category: 'Hierarchy_Model',          template: dsl_BasicNode, param: { g, hasTag: false,  hasType:false,   minSize: new go.Size(150,60),  figure: "Project",    fill: "PaleGoldenrod",    isFromLinkable: true,  isToLinkable: true, labelStroke: "black", isLabelEditable: false} },
    ...
    dataNodeList: [
      ...
      },
      {
        ...
        size: '240 80',
        rows: [
          { name: 'isAutostart', value: 'false' },
          { name: 'isPersistent', value: 'false' },
          { name: 'isNodePersistencyUsed', value: 'true' },
        ],
      },
      {
        label: 'File',
