...
function CodeFlowDSL_getDSL( g ) {
  ...
  const dsl = {
    templateNodeList: [
      ...
      { category: 'CodeFlow_Library',         template: dsl_Component, param: { portId: '',        fromLinkable: false, toLinkable: false, hasTag: false,  hasType: true,  isTypeEditable: false, type: '@fileTypeName', hasValue: false, hasUnit: false,  figure: 'Rectangle',       hasInputs: false, hasOutputs: false, hasFunctionButtons: false, hasProperties: false,  } },
      { category: 'Property_GraphInfo',         template: dsl_Component, param: { portId: '',        fromLinkable: false, toLinkable: false, hasTag: false,  hasType: false, isTypeEditable: false,                        hasValue: true,  hasUnit: false,  figure: 'File',            hasInputs: false, hasOutputs: false, hasFunctionButtons: false, hasProperties: true,  canAddProperties: false} },
      { category: 'CodeFlow_Param',           template: dsl_Component, param: { portId: '',        fromLinkable: false, toLinkable: false, hasTag: false,  hasType: false, isTypeEditable: false,                        hasValue: true,  hasUnit: false,  figure: 'BendedLeftRight', hasInputs: false, hasOutputs: false, hasFunctionButtons: false, hasProperties: true,  canAddProperties: true, } },
      { category: 'CodeFlow_Button',          template: dsl_Component, param: { portId: '',        fromLinkable: false, toLinkable: false, hasTag: false,  hasType: false, isTypeEditable: false,                        hasValue: true,  hasUnit: false,  figure: 'Rectangle',       hasInputs: false, hasOutputs: false, hasFunctionButtons: true,  hasProperties: true,  canAddProperties: false,  fromLinkable: true,  toLinkable: false, fromSpot: go.Spot.Center, toSpot:go.Spot.Center, buttonMinSize: new go.Size(70, 20), textAlign: 'left', } },
      { category: 'CodeFlow_FeatureOnOff',    template: dsl_Component, param: { portId: 'Feature', fromLinkable: true,  toLinkable: true,  hasTag: false,  hasType: false, isTypeEditable: false,                        hasValue: false, hasUnit: false,  figure: 'Rectangle',       hasInputs: false, hasOutputs: false, hasFunctionButtons: true,  hasProperties: false, buttonInternalCallback: featureOnOff, isCheckBoxes: true, hasProperties: false, labelStroke: 'white',     fromSpot: go.Spot.Center, toSpot:go.Spot.Center, buttonStroke: 'white', textAlign: 'left',} },
      ...
      { category: 'CodeFlow_File',            template: dsl_BasicNode, param: { portId: 'File',    fromLinkable: true,  toLinkable: true,  hasTag: false,  hasType: true,  isTypeEditable: false, type: '@fileTypeName', hasValue: false, hasUnit: false,  figure: 'File',            minSize: new go.Size(150,40), textAlign: 'center',                  labelStroke: 'black', typeMenu: fileTypeContextMenu,  } },
      { category: 'CodeFlow_Bus',             template: dsl_BasicNode, param: { portId: 'Bus',     fromLinkable: true,  toLinkable: true,  hasTag: false,  hasType: false,  isTypeEditable: false, hasValue: false, hasUnit: false,  figure: 'ellipse',            minSize: new go.Size(40,40), textAlign: 'center',                  labelStroke: 'black',  } },
    ],
    dataNodeList: [
      {
        label: 'Graph Info',
