...
/*		const groupTemplate = $(go.Group, "Vertical",
  ...
  const dsl = {
    templateNodeList: [
      { category: 'Hierarchy_FolderContent',  template: dsl_BasicNode, param: {hasTag: false,  hasType:false,   minSize: new go.Size(150,100), figure: "Folder",     fill: "white", textAlign: "center",  fromLinkable: true,  toLinkable: true, labelStroke: "black", hasImage: "content" } },
      { category: 'Hierarchy_FolderImage',    template: dsl_BasicNode, param: {hasTag: false,  hasType:false,   minSize: new go.Size(150,100), figure: "Folder",     fill: "white", textAlign: "center",  fromLinkable: true,  toLinkable: true, labelStroke: "black", hasImage: "user" } },
      { category: 'Hierarchy_Folder',         template: dsl_BasicNode, param: {hasTag: false,  hasType:false,   minSize: new go.Size(150,60),  figure: "Folder",     fill: "white", textAlign: "center",  fromLinkable: true,  toLinkable: true, labelStroke: "black"} },
      ...
      { category: 'Hierarchy_CodeInFile',     template: dsl_BasicNode, param: {hasTag: false,  hasType:true,    type: '@fileTypeName', editableType: false, minSize: new go.Size(150,40),   figure: "File",       fill: "lightseagreen",    textAlign: "center",  fromLinkable: true,  toLinkable: true, labelStroke: "black", typeMenu: fileTypeContextMenu} },
      { category: 'Hierarchy_CodeInGraph',    template: dsl_BasicNode, param: {hasTag: false,  hasType:true,    type: '@fileTypeName', editableType: false, minSize: new go.Size(150,40),   figure: "FileCircle", fill: "lightseagreen",    textAlign: "center",  fromLinkable: true,  toLinkable: true, labelStroke: "black", typeMenu: fileTypeContextMenu} },
