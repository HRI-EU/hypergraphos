  ...
  */
  ...
  const dsl = {
    ...
    templateNodeList: [
      ...
      { category: 'Dialog_And',               template: dsl_BasicNode, param: {hasTag: false, hasType:false, maxSize: new go.Size(40,40),  figure: "circle", fill: "green",      label: "&",     portId: "And",         textAlign: "center", fromLinkable: true,  toLinkable: true, labelStroke: "white", editable: false,} },
      { category: 'Dialog_InhibitAnd',        template: dsl_BasicNode, param: {hasTag: false, hasType:false, maxSize: new go.Size(40,40),  figure: "circle", fill: "IndianRed",  label: "&",     portId: "InhibitAnd",  textAlign: "center", fromLinkable: true,  toLinkable: true, labelStroke: "white", editable: false,} },
      { category: 'Dialog_Rule',              template: dsl_BasicNode, param: {hasTag: false, hasType:false, maxSize: new go.Size(80,80),  figure: "circle", fill: "peru",       label: "@key",  portId: "Rule",        textAlign: "center", fromLinkable: true,  toLinkable: true, labelStroke: "white"} },
      { category: 'Dialog_BigComment',        template: dsl_BasicNode, param: {hasTag: false, hasType:false, minSize: new go.Size(300,80), font: "bold 32px sans-serif",                                                textAlign: "center", fromLinkable: false, toLinkable: false, labelStroke: "darkgray",} },
      { category: 'Dialog_RuleComment',       template: dsl_BasicNode, param: {hasTag: false, hasType:false, minSize: new go.Size(100,40), font: "bold 20px sans-serif",                         portId: "RuleComment", textAlign: "left",   fromLinkable: false, toLinkable: true,  toSpot: go.Spot.Left, toMaxLinks: 1, fill: "LightGray", margin: 10,} },
      ...
      { category: 'Dialog_Grammar',           template: dsl_Component, param: {hasInputs: false, hasOutputs: false, hasFunctionButtons: false, hasTag: true,  hasType: true,  hasValue: false,  hasUnit: false,  figure: "BendedLeftRight",  fill: "LemonChiffon", editable: true, keyStroke: "blue", portId: "",  fromLinkable: false, toLinkable: false,} },
      { category: 'Dialog_Component',         template: dsl_Component, param: {hasTag: false, hasType:false, figure: "Rectangle",              fill: "lightcyan",    editable: true, portId: "", fromLinkable: false, toLinkable: false, hasProperties: false} }, 
