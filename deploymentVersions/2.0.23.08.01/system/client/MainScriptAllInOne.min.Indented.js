...
class EditorChangeManager {
  ...
  editorHasChanged() {
      this.isPauseChage || (null == EditorChangeManager.unsavedEditor[this.id] && (EditorChangeManager.unsavedEditor[this.id] = 0), ++EditorChangeManager.unsavedEditor[this.id], EditorChangeManager.onGlobalNeedSaveCallback && EditorChangeManager.onGlobalNeedSaveCallback(), ++this.changeCount, this.isEditorSaved = !0, this._startSaveTimer(), Object.keys(EditorChangeManager.unsavedEditor))
  }
  isNeedSave() {
      return null != EditorChangeManager.unsavedEditor[this.id]
  }
  onDoSave(e) {
  ...
  editorSaved() {
      this.clearStatus(), delete EditorChangeManager.unsavedEditor[this.id], 0 == Object.keys(EditorChangeManager.unsavedEditor).length && EditorChangeManager.onGlobalIsSavedCallback && EditorChangeManager.onGlobalIsSavedCallback()
  }
  suggestToSave() {
      this.saveTimer && (this._clearSaveTimer(), this._signalToSave())
  }
  clearStatus() {
      this.saveTimer && (this._clearSaveTimer(), this.isChanged = !1, this.changeCount = 0)
  }
  _startSaveTimer() {
      this._clearSaveTimer(), 0 < this.saveTimeOut && (this.saveTimer = setTimeout(this._signalToSave.bind(this), this.saveTimeOut), this.onNeedSaveCallback) && this.onNeedSaveCallback()
  }
  _clearSaveTimer() {
...
EditorChangeManager.unsavedEditor = {}, EditorChangeManager.onGlobalNeedSaveCallback = null, EditorChangeManager.onGlobalIsSavedCallback = null, EditorChangeManager.onGlobalNeedSave = function(e) {
  EditorChangeManager.onGlobalNeedSaveCallback = e
}, EditorChangeManager.onGlobalIsSaved = function(e) {
  EditorChangeManager.onGlobalIsSavedCallback = e
};
class EditorBase extends EditorChangeManager {
  ...
  storeWindowPosition() {
      this.id != config.htmlDiv.graphDiv && m.e.getEditorInfo(this.id) && m.e.saveWindowPosition(this.id, this.nodeData, this.isPin())
  }
  setPinOn() {
  ...
  setSourceLastModificationTime(e) {
      this.mtime = e
  }
  doLoadLastUpdateTime(t, i) {
      getNodeInfoFromServer(t, e => {
          e.mtime && this.setSourceLastModificationTime(e.mtime), i && i(t)
      })
  }
  doCheckLastUpdateTime(o, a) {
      getNodeInfoFromServer(o, e => {
          let t = !1;
          var i = this.getSourceLastModificationTime();
...
class Graph {
  constructor(e) {
      e = e || {}, this.diagram = null, this.fullPaletteId = null, this.nodePalette = null, this.groupPalette = null, this.linkPalette = null, this.lastNodeKey = null, this.dslNameList = [], this.isReadOnly = !1, this.graphPath = "", e.fullPaletteId && (this.fullPaletteId = e.fullPaletteId), e.nodePaletteId && (this.nodePalette = this.newNodePalette(e.nodePaletteId)), e.groupPaletteId && (this.groupPalette = this.newGroupPalette(e.groupPaletteId)), e.linkPaletteId && (this.linkPalette = this.newLinkPalette(e.linkPaletteId)), e.graphId ? this.diagram = this.newDiagram(e.graphId) : this.diagram = this.newDiagram(), this.em = new EventManager, this.em.addList({
          onSelection: {
...
class GraphEditor extends EditorBase {
  constructor(e, t, i) {
      ...
      }), null != config.graph.allowDeleteKey && this.editor.setAllowDeleteKey(config.graph.allowDeleteKey), null != config.graph.isDoubleClickCreateNodeEnabled && this.editor.setAllowDoubleCliceCreateNode(config.graph.isDoubleClickCreateNodeEnabled), this.setPauseChange(!0), this.onDoSave(() => {
      ...
      const o = () => {
          ...
          this.editor.setIsHistoryEmpty(t.length <= 0), this.navigateToGraph(e, !0)
      };
      this.editor.registerEventList({
          onGraphChanged: () => {
              this.isContentJustLoaded || this.editorHasChanged()
          },
          onSelection: e => {
          ...
          onLoadGraph: e => {
              ...
              this._verifyFileURL(e), this.navigateToGraph(e)
          },
          onLoadFile: (e, t, i) => {
              e = getNodeData(e.key, !0);
              this._verifyFileURL(e), m.e.openWindowFromNodeData(e, t, i)
          },
          onClone: e => {
              if (e.fileURL) {
                  ...
                  loadNodeContent(o, e => {
                      var t = o.fileURL,
                          i = (o.fileURL = "", this._verifyFileURL(o), o.fileURL);
                      m.e.cloneGraphWindow(t, i), o.fileContent = e, saveNodeContent(o)
                  })
              }
          },
          onShowRootGraph: () => {
              var e = config.graph.rootGraphNodeData;
              this.navigateToGraph(e)
          },
          onSetReadOnly: e => {
              setSystemReadOnly(e)
          },
      ...
      }), this.setPauseChange(!1), this.loadEditorContent(t)
  }
  addListerner(e, t) {
      this.listenerList[e] && this.listenerList[e].push(t)
  }
  navigateToGraph(e, t) {
      t = null != t && t, e && this.suggestSaveEditorContent(() => {
          t || m.e.updateGraphHistory(), this.loadEditorContent(e)
      })
  }
  loadEditorContent(i, o) {
      if ((i || i.isDir) && i.fileType == this.fileType) {
          this.setPauseChange(!0), this.isContentJustLoaded = !0;
          const a = () => {
                  this.processNodeWithIncludeScripts("unload"), this.processNodeWithIncludeScripts("load"), setStatus(e => e.currentGraphNode = i), m.e.reopenGraphSession(i.fileURL);
                  var e = getStatus("graphHistory"),
                      e = (this.editor.setIsHistoryEmpty(e.length <= 0), this.editor.setIsRootGraph(i.fileURL == config.graph.rootGraphURL), this.setPauseChange(!1), this.title = this.id, i.label ? this.title = i.label : i.text ? this.title = i.text : i.key && (e = i.key, isNaN(e)) && (this.title = i.key), setTimeout(() => this.isContentJustLoaded = !1, 50), this.listenerList.onLoad);
                  if (0 < e.length)
              ...
              t = e => {
                  ...
                  !e && t.length <= 0 ? (i = config.graph.rootGraphNodeData, this.loadEditorContent(i, () => {
                      this.doLoadLastUpdateTime(i, a)
                  })) : (this.editor.setEditorSource(e, () => {
                      this.doLoadLastUpdateTime(i, a)
                  }), this.editor.setGraphPath(i.fileURL))
              };
          var e = () => {
              this.nodeData && (i.fileURL == config.graph.rootGraphURL ? this.setParentGraph(null) : this.setParentGraph(this.nodeData)), loadNodeContent(this.nodeData = i, t)
          };
          this.nodeData ? m.e.closeAllEditor(e) : e()
      }
  }
  suggestSaveEditorContent(e) {
      this.isNeedSave() ? this.saveEditorContent(e) : e && e()
  }
  saveEditorContent(t) {
      let a = null;
      const n = {
          ...
          i = () => {
              this.doLoadLastUpdateTime(this.nodeData, e)
          };
      this.nodeData ? this.doCheckLastUpdateTime(this.nodeData, e => {
          e ? (this.clearStatus(), t && t()) : (a = this.editor._getDataCopy(this.nodeData), e = this.editor.getEditorSource(), a.fileContent = e, saveNodeContent(a, i))
      }) : i()
  }
  _verifyFileURL(e) {
      var t;
  ...
  processNodeWithIncludeScripts(e) {
      if ("unload" == e)
...
class TextEditor extends EditorBase {
  constructor(e, t, i) {
      super(), this.isJustStarted = !0, this.id = e, this.fileType = "", this.fileType = t.fileType || "text/text", this.editorDivId = m.e.newDOMWindow(e, this.title, config.htmlDiv.mainDiv, this.storeWindowPosition.bind(this), i), this.editor = new ACESourceCodeEditor(this.editorDivId);
      ...
      }), t.editorTheme ? this.editor.setEditorTheme(t.editorTheme) : document.getElementById(this.editorDivId).style.background = "#1d1f21", this.setPauseChange(!0), this.editor.onSourceChanged(() => {
          this.isJustStarted || this.editorHasChanged(), this.isJustStarted = !1
      }), this.onDoSave(() => {
          this.saveEditorContent()
      }), this.setPauseChange(!1), this.loadEditorContent(t)
  }
  loadEditorContent(t) {
      this.setPauseChange(!0), this.fileType = t.fileType || this.fileType, this.nodeData = t, this.title = (t.label || t.key) + ` [${this.fileType}]`, this.setTitle(this.title), t.fileURL && m.e.showWindowPin(this.id, "visible"), loadNodeContent(t, e => {
          this.editor.setEditorSource(e), this.doLoadLastUpdateTime(t, () => {
              this.setPauseChange(!1)
          })
      }), t.onNodeChanged && t.onNodeChanged(this.loadEditorContent.bind(this))
  }
  saveEditorContent(i) {
      const o = () => {
          this.editorSaved(), i && i()
      };
      this.nodeData ? this.doCheckLastUpdateTime(this.nodeData, e => {
          var t;
          e ? (this.clearStatus(), i && i()) : (e = this.editor.getEditorSource(), (t = m.e.getEditor(config.htmlDiv.graphDiv)._getDataCopy(this.nodeData)).fileContent = e, saveNodeContent(t, o))
      }) : o()
  }
}
class HTMLExploreEditor extends EditorBase {
  constructor(e, t, i) {
      super(), this.isJustStarted = !0, this.id = e, this.fileType = "", this.editorDiv = null, this.fileType = t.fileType || "application/explore", this.editorDivId = m.e.newDOMWindow(e, this.title, config.htmlDiv.mainDiv, this.storeWindowPosition.bind(this), i);
      ...
      this.editor = ExploreEditor.create(e, {
          ...
          charCounter: !0
      }), this.setPauseChange(!0), this.editor.onChange = () => {
          this.isJustStarted || this.editorHasChanged(), this.isJustStarted = !1
      }, this.onDoSave(() => {
          this.saveEditorContent()
      }), this.setPauseChange(!1), this.loadEditorContent(t)
  ...
  loadEditorContent(t) {
      this.setPauseChange(!0), this.fileType = t.fileType || this.fileType, this.nodeData = t, this.title = (t.label || t.key) + ` [${this.fileType}]`, this.setTitle(this.title), t.fileURL && m.e.showWindowPin(this.id), loadNodeContent(t, e => {
          this.editor.setContents(e), this.doLoadLastUpdateTime(t, () => {
              this.setPauseChange(!1)
          })
      }), t.onNodeChanged && t.onNodeChanged(this.loadEditorContent.bind(this))
  }
  saveEditorContent(i) {
      ...
      this.nodeData ? this.doCheckLastUpdateTime(this.nodeData, e => {
          var t;
          e ? (this.clearStatus(), i && i()) : (e = this.editor.getContents(), (t = m.e.getEditor(config.htmlDiv.graphDiv)._getDataCopy(this.nodeData)).fileContent = e, saveNodeContent(t, o))
      }) : o()
  }
}
class ImageEditor extends EditorBase {
  constructor(e, t, i) {
      super(), this.id = e, this.editor = null, this.editorDivId = m.e.newDOMWindow(e, this.title, config.htmlDiv.mainDiv, this.storeWindowPosition.bind(this), i), document.getElementById(this.editorDivId).style.background = "#1d1f21", this.loadEditorContent(t)
  }
  loadEditorContent(e) {
      var t;
      this.nodeData = e, this.title = (e.label || e.key) + ` [${e.fileType}]`, this.setTitle(this.title), e.fileURL && m.e.showWindowPin(this.id), e.fileURL && (t = document.getElementById(this.editorDivId), e = e.fileURL || "", t.style.backgroundImage = `url("${e}")`, t.style.backgroundSize = "cover")
  }
  saveEditorContent(e) {
      e && e()
  }
...
class WebViewer extends EditorBase {
  constructor(e, t, i) {
      super(), this.id = e, this.editor = null, this.editorDivId = m.e.newDOMWindow(e, this.title, config.htmlDiv.mainDiv, this.storeWindowPosition.bind(this), i), this.loadEditorContent(t)
  }
  loadEditorContent(nodeData) {
      if (this.nodeData = nodeData, this.title = (nodeData.label || nodeData.key) + ` [${nodeData.fileType}]`, this.setTitle(this.title), nodeData.fileURL && m.e.showWindowPin(this.id), nodeData.isLocalDiv && null != nodeData.fileContent) {
...
class FindViewer extends EditorBase {
  constructor(e, t, i) {
      super(), this.id = e, this.editor = null, this.foundInfo = {
          ...
          foundList: [],
          elementList: []
      }, this.editorDivId = m.e.newDOMWindow(e, this.title, config.htmlDiv.mainDiv, this.storeWindowPosition.bind(this), i), document.getElementById(this.editorDivId).style.background = "#1d1f21", this.loadEditorContent(t)
  }
  loadEditorContent(e) {
      const u = m.e.getEditor(config.htmlDiv.graphDiv);
      var t = 'Examples:&#013;     d.field == "1"&#013;     == "1"&#013;     "1"&#013;Field names are:&#013;' + ("    " + u.getDSLFieldNameList().join("&#013;    "));
      this.nodeData = e, this.title = (e.label || e.key) + ` [${e.fileType}]`, this.setTitle(this.title), document.getElementById(this.editorDivId).innerHTML = `<div class="search" style="width:100%;position:absolute;background-color:inherit">
...
class DSLViewer extends EditorBase {
  ...
  loadEditorContent(e) {
      this.nodeData = e, this.title = (e.label || e.key) + ` [${e.fileType}]`, this.setTitle(this.title);
...
class SystemMonitorViewer extends EditorBase {
  constructor(e, t, i) {
      super(), this.id = e, this.editor = null, m.e.getEditorInfo(config.htmlDiv.graphDiv).addListerner("onLoad", () => this.loadEditorContent(t)), this.editorDivId = m.e.newDOMWindow(e, this.title, config.htmlDiv.mainDiv, this.storeWindowPosition.bind(this), i), document.getElementById(this.editorDivId).style.background = "#1d1f21", this.loadEditorContent(t), setInterval(() => this.loadEditorContent(this.nodeData), 3e4)
  }
  loadEditorContent(e) {
      this.nodeData = e, this.title = (e.label || e.key) + ` [${e.fileType}]`, this.setTitle(this.title), e.fileURL && m.e.showWindowPin(this.id), document.getElementById(this.editorDivId).innerHTML = `<div style="width=100%;height = 100%">
                        ...
                        <div id='windowList'></div>`, document.querySelector("#sysMonitorRefresh").onclick = () => this.loadEditorContent(e);
      ...
      for (const a of m.e.getEditorIdList()) {
          var o = m.e.getEditorBasicInfo(a);
          let e = o.screenDirection;
          0 != o.screenIndex && (e += `[${Math.abs(o.screenIndex)}]`);
          o = `<tr><td>[${o.id}]<td>${o.title}<td>URL: ${o.url}<td>${e}</tr>`;
          i += o
      }
      t.innerHTML = i, this.editorSaved(this.id)
  }
  saveEditorContent(e) {
      this.editorSaved(), e && e()
  }
}
class AnimatorEditor extends EditorBase {
  constructor(e, t, i) {
      super(), this.id = e, this.editor = null, this.title = "Animator Editor", this.editorDivId = m.e.newDOMWindow(e, this.title, config.htmlDiv.mainDiv, this.storeWindowPosition.bind(this), i), this.editor = new ACESourceCodeEditor(this.editorDivId);
      this.editor.setEditorMode("ace/mode/text"), this.editor.setEditorSource('// Put here animation info, like: {"key":10}'), this.editor.onEvent("changeSelection", this._onEditorSelectionChanged.bind(this)), this.graphEditor = m.e.getEditor(config.htmlDiv.graphDiv), this.loadEditorContent(t)
  }
  animateNode(e) {
      let t = "",
          i = (t = null == e ? this.editor.getCurrentLineText() : this.editor.getLineTextAt(e), this._getJSONLineInfo(t));
      if (i && null == i.key)
...
class EditorManager extends EditorChangeManager {
  constructor() {
      super(.5), this.id = "Session", this.registeredEditorList = [{
          ...
          classRef: ImageEditor
      }, {
          name: "GraphEditor",
          fileType: e => "text/json" == e,
          classRef: GraphEditor
      }, {
          name: "FindViewer",
          ...
          fileType: e => "input/fields" == e,
          classRef: GraphTemplateViewer
      }, {
          name: "SystemMonitorViewer",
          fileType: e => "system/status" == e,
          classRef: SystemMonitorViewer
      }, {
          name: "AnimatorEditor",
          fileType: e => "input/fields" == e,
          classRef: AnimatorEditor
  ...
  openSelectionWindow() {
      ...
      t && (e.updateSystemNode(t), e = getNodeData(t.key, !0), this.openWindowFromNodeData(e), e = this.getWindowDiv(t)) && e.classList.add(t.isSystem.slice(1, -1))
  }
  openModelWindow() {
      var e = this.getEditor(config.htmlDiv.graphDiv),
  ...
  openWindowFromNodeData(e, t, i) {
      t = null != t && null != i ? [t, i, 400, 350] : void 0, i = m.e._getDOMUniqueId(e);
      m.e.openWindow(i, null, e, t), e.isSystem && m.e.getEditorInfo(i).showSaveButton()
  }
  openWindow(t, i, o, a, n) {
      var s, r, l;
      if (a = null == a ? [100, 100, 400, 350] : a, n = null != n && n, this.isEditorOpen(t, o)) 0 != (s = this.getEditorBasicInfo(t)).screenIndex && this.moveAllWindowTo(s.screenFactor), this.putWindowOnTop(t);
          ...
          e && (r = (s = getStatus("currentGraphNode")).fileURL, (l = getStatus("openWindowList"))[r] && l[r][o.key] && (a = l[r][o.key]), e = new e.classRef(t, o, a), (this.editorList[t] = e).setParentGraph(s), this.putWindowOnTop(t), n && e.setPinOn(), e.storeWindowPosition(), this.suggestToSave())
      }
  }
  newDOMWindow(e, t, i, o, a) {
      var n = e + "Editor",
  ...
  saveEditor(e, t) {
      ...
      e.clearStatus(), e.saveEditorContent(t)
  }
  saveEditorContent(e) {
      saveStatus(() => {
          this.editorSaved(), e && e()
  ...
  pinEditor(e, t) {
      var i = this.getEditorInfo(e),
          o = i.nodeData;
      if (this.tooglePinNodeData(o, t), this.isURLPinned(o.fileURL)) {
          var t = getStatus("openWindowList"),
              a = i.getParentGraph();
          a && (t[a = a.fileURL] && t[a][o.key] && delete t[a][o.key], this.showWindowPin(e, "pinned"), this.editorHasChanged())
      } else {
          const n = getStatus("openWindowList");
          t = i.getParentGraph();
          t && (a = t.fileURL, n[a] && n[a][o.key] || (n[a] || (n[a] = {}), i = this.getEditorPosition(e), n[a][o.key] = i, setStatus(e => e.openWindowList = n), this.showWindowPin(e, "unpinned")))
      }
  }
  tooglePinNodeData(e, t) {
      t = null != t && t;
  ...
  reopenStartSession() {
      ...
      if (e)
          for (const a of Object.keys(e)) {
              var t, i, o = e[a];
              "#systemPalette#" != a ? (t = this._getDOMUniqueId(o), i = o.editorPosition, this.openWindow(t, null, o, i, !0), this.showWindowPin(t, "hidden"), o.isSystem && m.e.getEditorInfo(t).showSaveButton()) : this.getEditor(config.htmlDiv.graphDiv).restorePalette(o)
          }
  }
  reopenGraphSession(e) {
      ...
      if (i && t && e && t[e])
          for (const s of Object.keys(t[e])) {
              ...
              n ? (a = t[e][s], n && (o = this._getDOMUniqueId(n), this.openWindow(o, null, n, a), n.isSystem) && (m.e.getEditorInfo(o).showSaveButton(), a = this.getWindowDiv(n)) && a.classList.add(n.isSystem.slice(1, -1))) : (delete t[e][s], this.editorHasChanged())
          }
      this.isStatusOnUpdate = !1
  }
  cloneGraphWindow(e, t) {
      this.isStatusOnUpdate = !0;
  ...
  closeEditor(a, n, s) {
      if (null == n) this.closeAllEditor(s);
      else if (n == config.htmlDiv.graphDiv) s && s();
      else {
          const r = this.getEditorInfo(n);
          a || !r.isPin() ? (r.onClosing(), this.saveEditor(n, () => {
              if (a) {
              ...
              t.parentNode.removeChild(t), s && s(), this.editorHasChanged()
          })) : s && s()
      }
  }
  closeAllEditor(e) {
          ...
          const u = h / 100,
              ...
              g = () => {
                  if (Math.abs(r) < Math.abs(h)) {
                      ...
                      this.editorHasChanged(), this.isMoveAllWindowRunning = !1
                  }
              };
          setTimeout(g, s)
      }
  ...
  _closeIdListEditor(e, t) {
      if (Array.isArray(e)) {
          const i = [...e];
          e = i.pop();
          e ? this.closeEditor(!1, e, () => {
              this._closeIdListEditor(i, t)
          }) : t && t()
      } else t && t()
  }
  _setEditorZIndex(e, t) {
      e = document.getElementById(e);
      e && (e.style.zIndex = t)
  }
}
...
function _init() {
  m.mddStatus = document.getElementById("mdd-status"), setDivAsResizable("#palette", "px", () => {
      _resizeWindow(), m.e.updateSessionStatus()
  }), loadFileServerInfo(), loadCurrentStatus(urlParams)
}
...
function setFileIndexStatus(e) {
  e && (e(m), m.isJustStarted || m.e.editorHasChanged(m.e.id))
}

function setStatus(e) {
  e && (e(m.status), m.isJustStarted || m.e.editorHasChanged(m.e.id))
}
...
function saveStatus(e) {
  ...
  m.e.updateSessionStatus(), _saveFile(t, JSON.stringify(m.status, null, 2), () => {
      m.e.editorSaved(m.e.id), e && e()
  })
}

function saveAllEditorContent() {
  for (const e of Object.keys(EditorChangeManager.unsavedEditor)) m.e.getEditorInfo(e).saveEditorContent()
}
...
function loadCurrentStatus(i) {
  _openFile(config.host.statusURL, e => {
      m.status = JSON.parse(e), m.status.fileServer && delete m.status.fileServer, m.e = new EditorManager(m.status);
      ...
      (t = i.url && i.url.startsWith(config.host.fileServerURL) && i.url.endsWith(".json") ? {
          ...
          fileURL: i.url,
          fileType: "text/json"
      } : t).fileURL || (t = config.graph.rootGraphNodeData), m.e.openWindow(e, "GraphEditor", t), m.e.reopenStartSession(), setTimeout(() => m.isJustStarted = !1, 500), EditorChangeManager.onGlobalNeedSave(setSystemNeedSave), EditorChangeManager.onGlobalIsSaved(setSystemSaved)
  })
}
