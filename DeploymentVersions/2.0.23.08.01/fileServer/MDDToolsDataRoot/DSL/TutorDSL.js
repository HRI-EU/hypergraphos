  ...
  */
  ...
  const dsl = {
    ...
    templateNodeList: [
      ...
      { category: 'Tutor_And',               template: dsl_BasicNode, param: {hasTag: false, hasType:false, maxSize: new go.Size(40,40),  figure: "circle", fill: "green",      label: "&",     portId: "And",         labelTextAlign: "center", isFromLinkable: true,  isToLinkable: true, labelStroke: "white", isLabelEditable: false,} },
      { category: 'Tutor_InhibitAnd',        template: dsl_BasicNode, param: {hasTag: false, hasType:false, maxSize: new go.Size(40,40),  figure: "circle", fill: "IndianRed",  label: "&",     portId: "InhibitAnd",  labelTextAlign: "center", isFromLinkable: true,  isToLinkable: true, labelStroke: "white", isLabelEditable: false,} },
      { category: 'Tutor_Rule',              template: dsl_BasicNode, param: {hasTag: false, hasType:false, maxSize: new go.Size(80,80),  figure: "circle", fill: "peru",       label: "@key",  portId: "Rule",        labelTextAlign: "center", isFromLinkable: true,  isToLinkable: true, labelStroke: "white"} },
      { category: 'Tutor_BigComment',        template: dsl_BasicNode, param: {hasTag: false, hasType:false, minSize: new go.Size(300,80), labelFont: "bold 32px sans-serif",                                                labelTextAlign: "center", isFromLinkable: false, isToLinkable: false, labelStroke: "darkgray",} },
      { category: 'Tutor_RuleComment',       template: dsl_BasicNode, param: {hasTag: false, hasType:false, minSize: new go.Size(100,40), labelFont: "bold 20px sans-serif",                         portId: "RuleComment", labelTextAlign: "left",   isFromLinkable: false, isToLinkable: true,  toSpot: go.Spot.Left, toMaxLinks: 1, fill: "LightGray", labelMargin: 10,} },
      ...
      { category: 'Tutor_Grammar',           template: dsl_Component, param: {hasInputs: false, hasOutputs: false, hasFunctionButtons: false, hasTag: true,  hasType: true,  hasValue: false,  hasUnit: false,  figure: "BendedLeftRight",  fill: "LemonChiffon", isLabelEditable: true, keyStroke: "blue", portId: "",  isFromLinkable: false, isToLinkable: false,} },
      { category: 'Tutor_Component',         template: dsl_Component, param: {hasTag: false, hasType:false, figure: "Rectangle",              fill: "lightcyan",    isLabelEditable: true, portId: "", isFromLinkable: false, isToLinkable: false, hasProperties: false} }, 
